...
class ConsultasEvaluacionClase extends StatelessWidget {
  static final String routeName = 'evaluacionClaseConsulta';

  @override
  Widget build(BuildContext context) {
    final evaluacionClaseBloc = Provider.evaluacionClaseBloc(context);
    evaluacionClaseBloc.cargarEvaluacionClase();

    return Scaffold(
      appBar: AppBar(
        title: Text("Evaluación clase", style: TextStyle(color: Colors.blue)),
