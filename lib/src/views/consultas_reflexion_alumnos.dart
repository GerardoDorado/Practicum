...
class ConsultasReflexionAlumno extends StatelessWidget {
  static final String routeName = 'reflexionAlumnoConsulta';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Reflexión", style: TextStyle(color: Colors.blue)),
        ...
        child: Column(
          children: <Widget>[
            ListTile(
              ...
              title: Text(
                'Preguntas para orientar la reflexión: ${evaluacionClase.preguntas}\nReflexón estudiante: ${evaluacionClase.reflexion}',
                style: TextStyle(
