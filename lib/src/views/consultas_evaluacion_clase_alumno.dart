...
class ConsultasEvaluacionClaseAlumno extends StatelessWidget {
  static final String routeName = 'evaluacionClaseAlumnoConsulta';
        ...
        child: Column(
          children: <Widget>[
            ListTile(
              ...
              title: Text(
                'Evaluación: ${evaluacionClase.evaluacion}\nObservación: ${evaluacionClase.observacion}\nEvidencia:${evaluacionClase.evidencia}',
                style: TextStyle(
