...
class ConsultasEvaluacionFinalAlumno extends StatelessWidget {
  static final String routeName = 'evaluacionFinalAlumnoConsulta';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Evaluación final documento", style: TextStyle(color: Colors.blue)),
        ...
        child: Column(
          children: <Widget>[
            ListTile(
              ...
              title: Text(
                'Proyecto: ${inducciones.nombre}\nTemática: ${inducciones.tematica}',
                style: TextStyle(
                    color: Colors.black54, fontWeight: FontWeight.bold),
              ),
              subtitle: Text('Calificación: ${inducciones.evaluacion}'),
              onTap: (){} //=>
