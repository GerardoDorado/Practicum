...
class DocentesPrincipal extends StatefulWidget {
  static final String routeName = 'docentes_principal';
  
  @override
  _PaginaPrincipalState createState() => _PaginaPrincipalState();
}

class _PaginaPrincipalState extends State<DocentesPrincipal> {
